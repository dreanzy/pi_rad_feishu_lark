...
const DEFAULT_STATE: FeishuBridgeState = {
	version: 1,
	routes: {},
	jobs: {},
	sent: {},
...
function withDefaults(raw: FeishuBridgeState): FeishuBridgeState {
	return {
...
export class FeishuBridgeStore {
	...
	private read(): FeishuBridgeState {
		return withDefaults(
			readJson<FeishuBridgeState>(BRIDGE_PATH, DEFAULT_STATE),
		);
	}
